...
process.a2 = cms.EDAnalyzer("TestFindProduct",
  inputTags = cms.untracked.VInputTag( cms.InputTag("intProducer", process=cms.InputTag.skipCurrentProcess()) ),
...
process.a20 = cms.EDAnalyzer("TestFindProduct",
  inputTags = cms.untracked.VInputTag( cms.InputTag("intProducerU", process=cms.InputTag.skipCurrentProcess()) ),
...
process.a100 = cms.EDAnalyzer("TestFindProduct",
  inputTags = cms.untracked.VInputTag( cms.InputTag("source", process=cms.InputTag.skipCurrentProcess()) ),
...
process.a400 = cms.EDAnalyzer("TestFindProduct",
  inputTags = cms.untracked.VInputTag( cms.InputTag("aliasForInt", process=cms.InputTag.skipCurrentProcess()) ),
  expectedSum = cms.untracked.int32(300),
  inputTagsNotFound = cms.untracked.VInputTag(
    cms.InputTag("intProducerA", process=cms.InputTag.skipCurrentProcess())
  )
)
...
process.a1005 = cms.EDAnalyzer("TestFindProduct",
  inputTags = cms.untracked.VInputTag(),
  inputTagsView = cms.untracked.VInputTag( cms.InputTag("intVectorProducer", process=cms.InputTag.skipCurrentProcess()) ),
